...
{
    public partial class DialogAddAndUpdatePurchasesReturns : Form
    {
        PurchasesReturnsController controller;
        public DialogAddAndUpdatePurchasesReturns(PurchasesReturnsController controller)
        {
            InitializeComponent();
        ...
        private void DialogAddAndUpdatePurchasesReturns_Load(object sender, EventArgs e)
        {
        ...
        {
            supplier.SelectedItem = controller.temp.Supplier;
        ...
        {
            if (controller.dataProcessing(invoiceNumber.Text, exchangeRate.Text, amountPaid.Text, customTable1.newData))
            {
        ...
        public void item_Selection(object sender, EventArgs e)
        {
            ...
            if (item.id != 0)
            {
                ...
                if (measurement != null)
                {
                    ...
                    unitPrice.Text = (controller.isWholesale ? measurement.WholesalePurchasePrice : measurement.purchasePrice).Format();
