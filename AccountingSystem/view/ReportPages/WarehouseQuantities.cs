...
{
    public partial class WarehouseQuantities : Form
    {
        WarehouseQuantitiesController controller;
        public WarehouseQuantities()
        {
            InitializeComponent();
            controller = new WarehouseQuantitiesController();
        }

        private void headerReporte1_Load(object sender, EventArgs e)
        {
          
        }

        private void WarehouseQuantities_Load(object sender, EventArgs e)
        {
