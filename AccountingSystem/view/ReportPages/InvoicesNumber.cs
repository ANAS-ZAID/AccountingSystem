...
{
    public partial class InvoicesNumber : Form
    {
        InvoicesNumberController controller;
        public InvoicesNumber()
        {
            InitializeComponent();
            controller = new InvoicesNumberController();
        }
        private void InvoicesNumber_Load(object sender, EventArgs e)
        {
        ...
        void lodeData()
        {
            ...
            dataSetInvoicesNumberBindingSource.DataSource = controller.dataSource.DataSource;
